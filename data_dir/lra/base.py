...
from data_dir.lra.utils import is_list, permutations
from torch.nn import functional as F
from data_dir.lra.dataloader import PyTorchDataloaderWrapper
...
class DefaultCollateMixin:
    ...
    def _collate_fn(cls, batch, *args, **kwargs):
        ...
        y = cls._collate(y)
        y = torch.nn.functional.one_hot(y, num_classes=cls.d_output)
...
loader_registry = {
    None: PyTorchDataloaderWrapper, # default case
    #None: DataloaderJaxCopy
}
