...
from data_dir.lra.utils import permutations

from data_dir.lra.base import default_data_path, ImageResolutionSequenceDataset, ResolutionSequenceDataset, SequenceDataset
...
class CIFAR10(ImageResolutionSequenceDataset):
    ...
    def setup(self):
        ...
        self.dataset_train = torchvision.datasets.CIFAR10(
            f"{self.data_dir}/{self._name_}",
            train=True,
            download=True,
            transform=transform_train,
        )
        self.dataset_test = torchvision.datasets.CIFAR10(
            f"{self.data_dir}/{self._name_}", train=False, transform=transform_eval
        )
